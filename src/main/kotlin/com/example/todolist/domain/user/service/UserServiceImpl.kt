...
class UserServiceImpl: UserService {
    ...
    override fun updateUserProfile(userId: Long, request: UpdateUserProfileRequest): UserResponse {
        //TODO: 만약 id에 해당하는 User가 없다면 throw ModelNotFoundException
        //TODO: DB에서 id에 해당하는 User를 가져와서 updateUserProfileRequest로 업데이트 후 DB에 저장, 결과를 UserResponse로 변환 후 반환
        TODO("Not yet implemented")
    }
}